...
public class VmTest {
    ...
    private static final String jarPath = "/Users/weilai/Documents/future0923/debug-tools/debug-tools-attach/target/debug-tools-agent.jar";
    //private static final String jarPath = "/Users/weilai/Documents/future0923/debug-tools/debug-tools-attach/target/debug-tools-agent.jar";
    ...
    public static void attach() throws Exception {
        ...
        for (VirtualMachineDescriptor virtualMachineDescriptor : list) {
            boolean b = virtualMachineDescriptor.displayName().contains("DebugToolsTestApplication");
            if (b) {
    ...
    public void buildJsonStr() {
        args = "{\"targetClassName\":\"io.github.future0923.debug.tools.test.application.service.TestService\",\"targetMethodName\":\"test\",\"targetMethodParameterTypes\":[\"java.lang.String\",\"java.lang.Integer\",\"io.github.future0923.debug.tools.test.application.domain.TestEnum\",\"io.github.future0923.debug.tools.test.application.service.Test1Service\",\"java.util.function.BiFunction\",\"io.github.future0923.debug.tools.test.application.domain.dto.TestDTO\"],\"targetMethodContent\":{\"function\":{\"type\":\"lambda\",\"content\":\"(x, y) -> x + y\"},\"name\":{\"type\":\"simple\",\"content\":\"future0923\"},\"testEnum\":{\"type\":\"enum\",\"content\":\"TEST1\"},\"test1Service\":{\"type\":\"bean\"},\"age\":{\"type\":\"simple\",\"content\":\"19\"},\"dto\":{\"type\":\"json_entity\",\"content\":{\"name\":\"future0923\",\"age\":18}}}}";
    }
    ...
    public void buildSimple() {
        ...
        args = DebugToolsJsonUtils.toJsonStr(runDTO);
    }
    ...
    public void buildSpringBean() {
        ...
        runDTO.setTargetClassName("io.github.future0923.debug.tools.test.application.service.TestService");
        runDTO.setTargetMethodName("test");
        runDTO.setTargetMethodParameterTypes(Arrays.asList("io.github.future0923.debug.tools.test.application.service.Test1Service"));
        Map<String, RunContentDTO> contentMap = new HashMap<>();
    ...
    public void  buildEntity() {
        ...
        runDTO.setTargetClassName("io.github.future0923.debug.tools.test.application.service.TestService");
        runDTO.setTargetMethodName("test");
        runDTO.setTargetMethodParameterTypes(Arrays.asList("io.github.future0923.debug.tools.test.application.domain.dto.TestDTO"));
        Map<String, RunContentDTO> contentMap = new HashMap<>();
    ...
    public void  buildAll() {
        ...
        runDTO.setTargetMethodParameterTypes(Arrays.asList(
                "java.lang.String",
                "java.lang.Integer",
                "io.github.future0923.debug.tools.test.application.service.Test1Service",
                "java.util.function.BiFunction",
                "io.github.future0923.debug.tools.test.application.domain.dto.TestDTO"));
        Map<String, RunContentDTO> contentMap = new HashMap<>();
        contentMap.put("name", RunContentDTO.builder()
                .type(RunContentType.SIMPLE.getType())
                .content("future0923")
    ...
    public void buildFile() {
        args = "file://%2FUsers%2Fweilai%2FDocuments%2F/future0923%2Fdebug-tools%2Fdebug-tools-test%2Fdebug-tools-test-application%2F.idea%2FDebugTools%2Fagent.json";
    }

    @Test
    public void buildList() {
        args = "{\n" +
                "    \"targetClassName\": \"io.github.future0923.debug.tools.test.application.service.TestService\",\n" +
    ...
    public void buildDaoSelect() {
        args = "{\n" +
                "    \"targetClassName\": \"io.github.future0923.debug.tools.test.application.dao.UserDao\",\n" +
