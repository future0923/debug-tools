 ...
 * @author future0923
 */
public class SqlDialogWrapper extends DialogWrapper {
    ...
    public SqlDialogWrapper(@Nullable Project project, String sql) {
        ...
        this.sql = SqlFormatter.format(sql);
        setTitle("Sql Detail");
        setOKButtonText("Ok");
        init();
    }
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        EditorTextField editorTextField = new EditorTextField(sql, project, sqlFileType);
