...
public class CamelCaseAction extends TextComponentEditorAction {
    ...
    public CamelCaseAction() {
        ...
        getTemplatePresentation().setText(DebugToolsBundle.message("action.convert.camel.case"));
        getTemplatePresentation().setDescription(DebugToolsBundle.message("action.convert.camel.case"));
    }
}
