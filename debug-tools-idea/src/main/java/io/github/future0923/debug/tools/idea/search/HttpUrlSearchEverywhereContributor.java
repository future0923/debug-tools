...
public class HttpUrlSearchEverywhereContributor extends AbstractGotoSEContributor {
    private List<HttpUrlItem> allController;
    ...
    public @NotNull ListCellRenderer<Object> getElementsRenderer() {
        return new PsiElementListCellRenderer<>() {
            ...
            protected boolean customizeNonPsiElementLeftRenderer(ColoredListCellRenderer renderer, JList list, Object value, int index, boolean selected, boolean hasFocus) {
                ...
                SpeedSearchUtil.appendColoredFragmentForMatcher(presentation.getPresentableText(), renderer, urlNameAttributes, itemMatchers.nameMatcher, bgColor, selected);
