...
public class NewSettingPanel {
    ...
    private JPanel baseSettingPanel;
    private JPanel quickDebugSettingPanel;
    private JPanel sqlSettingPanel;
    ...
    private JCheckBox autoAttachCheckBox;
    private JLabel autoAttachHelpLabel;

    private JLabel entityParamTypeLabel;
    private JComboBox<String> entityParamTypeComboBox;
    private JLabel entityParamTypeHelpLabel;

    private JCheckBox invokeMethodRecordCheckBox;
    private JLabel invokeMethodRecordHelpLabel;
    private JCheckBox lineMarkerCheckBox;
    private JLabel lineMarkerHelpLabel;
    private JCheckBox traceMethodRecordCheckBox;
    private JLabel traceMethodRecordHelpLabel;
    ...
    public NewSettingPanel(Project project) {
    ...
    private void initLayout() {
        ...
        baseSettingPanel.setBorder(IdeBorderFactory.createTitledBorder(DebugToolsBundle.message("setting.panel.base.setting"), false));
        quickDebugSettingPanel.setBorder(IdeBorderFactory.createTitledBorder(DebugToolsBundle.message("setting.panel.quick.debug.setting"), false));
        sqlSettingPanel.setBorder(IdeBorderFactory.createTitledBorder(DebugToolsBundle.message("setting.panel.sql.setting"), false));
        otherSettingPanel.setBorder(IdeBorderFactory.createTitledBorder(DebugToolsBundle.message("setting.panel.other.setting"), false));

        languageLabel.setText(DebugToolsBundle.message("setting.panel.language"));
        logLevelLabel.setText(DebugToolsBundle.message("setting.panel.log.level"));
        autoAttachCheckBox.setText(DebugToolsBundle.message("setting.panel.auto.attach"));
        autoAttachHelpLabel.setText(DebugToolsBundle.message("setting.panel.auto.attach.help"));
        autoAttachHelpLabel.setForeground(UIUtil.getContextHelpForeground());

        entityParamTypeLabel.setText(DebugToolsBundle.message("setting.panel.entity.class.default.param"));
        entityParamTypeComboBox.setModel(new CollectionComboBoxModel<>(Arrays.asList(DebugToolsBundle.message(GenParamType.SIMPLE.getBundleKey()),
                DebugToolsBundle.message(GenParamType.CURRENT.getBundleKey()), DebugToolsBundle.message(GenParamType.ALL.getBundleKey()))));
        invokeMethodRecordCheckBox.setText(DebugToolsBundle.message("setting.panel.invoke.method.record"));
        lineMarkerCheckBox.setText(DebugToolsBundle.message("setting.panel.quick.action.line.marker"));
        traceMethodRecordCheckBox.setText(DebugToolsBundle.message("setting.panel.trace.method"));

        entityParamTypeHelpLabel.setText("Specify parameter types for the quick debug method");
        entityParamTypeHelpLabel.setForeground(UIUtil.getContextHelpForeground());

        invokeMethodRecordHelpLabel.setText("When enabled, quick debug method will be tracked. ");
        invokeMethodRecordHelpLabel.setForeground(UIUtil.getContextHelpForeground());

        lineMarkerHelpLabel.setText("When enabled, the icon on the left of the method allows quick calls.");
        lineMarkerHelpLabel.setForeground(UIUtil.getContextHelpForeground());

        traceMethodRecordHelpLabel.setText("When enabled, method execution time will be tracked.");
        traceMethodRecordHelpLabel.setForeground(UIUtil.getContextHelpForeground());
        ...
        // 初始化语言设置单选按钮
        languageComboBox.setModel(new CollectionComboBoxModel<>(Arrays.asList(LanguageSetting.IDE.getDisplayName(), LanguageSetting.ENGLISH.getDisplayName(), LanguageSetting.CHINESE.getDisplayName())));
        logLevelComboBox.setModel(new CollectionComboBoxModel<>(Arrays.asList("Trace", "Debug", "Info", "Warning", "Reload", "Error")));
//        genParamTypeComboBox.setModel(new CollectionComboBoxModel<>(Arrays.asList("Simple", "Current", "All")));
