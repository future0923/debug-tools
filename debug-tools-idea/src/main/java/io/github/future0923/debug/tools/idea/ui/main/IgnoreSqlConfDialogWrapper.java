 ...
 * sql忽略内容保存对话框
 */
public class IgnoreSqlConfDialogWrapper extends DialogWrapper {
    ...
    public IgnoreSqlConfDialogWrapper(@NotNull Project project) {
    ...
    protected void doOKAction() {
        WriteCommandAction.runWriteCommandAction(project, () -> {
            ...
            settingState.setIgnoreSqlConfigPath(filePath);
        });
        super.doOKAction();
    }
