 ...
 * @author future0923
 */
public class DebugPowerIcons {

    public static final Icon debug_power_icon = IconLoader.getIcon("/icon/plugin_icon.svg", DebugPowerIcons.class);
    public static final Icon example_simple_icon = IconLoader.getIcon("/icon/example_simple.svg", DebugPowerIcons.class);
    public static final Icon example_current_icon = IconLoader.getIcon("/icon/example_current.svg", DebugPowerIcons.class);
    public static final Icon example_all_icon = IconLoader.getIcon("/icon/example_all.svg", DebugPowerIcons.class);
    public static final Icon pretty_icon = IconLoader.getIcon("/icon/pretty.svg", DebugPowerIcons.class);
    public static final Icon compress_icon = IconLoader.getIcon("/icon/compress.svg", DebugPowerIcons.class);
