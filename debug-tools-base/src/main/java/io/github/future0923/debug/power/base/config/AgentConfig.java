package io.github.future0923.debug.power.base.config;
...
public class AgentConfig {
    ...
    private AgentConfig() {
        ...
        propertiesFile = new File(homeDir + "/" + ProjectConstants.NAME + "/debug-power-cache.properties");
        if (!propertiesFile.exists()) {
            DebugPowerFileUtils.touch(propertiesFile);
        }
        try {
