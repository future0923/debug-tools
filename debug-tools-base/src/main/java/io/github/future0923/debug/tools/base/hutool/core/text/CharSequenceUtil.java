...
import io.github.future0923.debug.tools.base.hutool.core.comparator.VersionComparator;
...
import io.github.future0923.debug.tools.base.hutool.core.text.NamingCase;
...
import io.github.future0923.debug.tools.base.hutool.core.text.StrSplitter;
import io.github.future0923.debug.tools.base.hutool.core.text.finder.CharFinder;
import io.github.future0923.debug.tools.base.hutool.core.text.finder.Finder;
import io.github.future0923.debug.tools.base.hutool.core.text.finder.StrFinder;
...
import io.github.future0923.debug.tools.base.hutool.core.util.DesensitizedUtil;
...
public class CharSequenceUtil {
	...
	public static boolean isBlank(CharSequence str) {
		...
		for (int i = 0; i < length; i++) {
			// 只要有一个非空字符即为非空字符串
			if (false == io.github.future0923.debug.tools.base.hutool.core.util.CharUtil.isBlankChar(str.charAt(i))) {
				return false;
			}
		}
	...
	public static boolean hasBlank(CharSequence... strs) {
		if (io.github.future0923.debug.tools.base.hutool.core.util.ArrayUtil.isEmpty(strs)) {
			return true;
		}
	...
	public static String replace(CharSequence str, java.util.regex.Pattern pattern, Func1<java.util.regex.Matcher, String> replaceFun) {
		return io.github.future0923.debug.tools.base.hutool.core.util.ReUtil.replaceAll(str, pattern, replaceFun);
	}
	 ...
	 * @since 5.6.2
	 */
	public static String desensitized(CharSequence str, io.github.future0923.debug.tools.base.hutool.core.util.DesensitizedUtil.DesensitizedType desensitizedType) {
