...
public class XmlBeanRefreshCommand extends MergeableCommand {
    private static Logger LOGGER = Logger.getLogger(XmlBeanRefreshCommand.class);
    ...
    public void executeCommand() {
        ...
        try {
            ...
            Class clazz = Class.forName("io.github.future0923.debug.tools.hotswap.core.plugin.spring.scanner.XmlBeanDefinitionScannerAgent", true, appClassLoader);
