 ...
 */
package io.github.future0923.debug.tools.hotswap.core.plugin.spring.transformers.support;
...
public class InitMethodEnhance {
    ...
    public static String catchException(String objectName, String loggerName, String exceptionName, String from,
        ...
        return "{"
            + "if (io.github.future0923.debug.tools.hotswap.core.plugin.spring.reload.BeanFactoryAssistant.getBeanFactoryAssistant($0) == null || "
