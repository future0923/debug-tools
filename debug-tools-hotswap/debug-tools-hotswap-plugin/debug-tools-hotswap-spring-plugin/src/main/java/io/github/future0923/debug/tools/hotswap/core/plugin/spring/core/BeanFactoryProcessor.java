...
import io.github.future0923.debug.tools.hotswap.core.plugin.spring.reload.BeanFactoryAssistant;
import io.github.future0923.debug.tools.hotswap.core.plugin.spring.transformers.api.BeanFactoryLifecycle;
import io.github.future0923.debug.tools.hotswap.core.plugin.spring.transformers.api.ValueResolverSupport;
...
public class BeanFactoryProcessor {
    ...
    private static final Logger LOGGER = Logger.getLogger(BeanFactoryProcessor.class);
