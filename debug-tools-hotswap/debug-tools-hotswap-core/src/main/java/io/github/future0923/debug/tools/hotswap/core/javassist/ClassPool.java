...
import io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.DefinePackageHelper;
...
public class ClassPool {
    ...
    {
        try {
            return io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.DefineClassHelper.toClass(neighbor,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
    ...
    {
        try {
            return io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.DefineClassHelper.toClass(lookup,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
            throw new CannotCompileException(e);
    ...
    {
        try {
            return io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.DefineClassHelper.toClass(ct.getName(),
