...
import io.github.future0923.debug.tools.hotswap.core.javassist.CodeConverter;
...
import io.github.future0923.debug.tools.hotswap.core.javassist.tools.reflect.ClassMetaobject;
...
public class Reflection implements Translator {
    ...
    static final String metaobjectClassName = "io.github.future0923.debug.tools.hotswap.core.javassist.tools.reflect.Metaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        classPool = pool;
        final String msg
            = "io.github.future0923.debug.tools.hotswap.core.javassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c = classPool.get("io.github.future0923.debug.tools.hotswap.core.javassist.tools.reflect.Sample");
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtClass mlevel = classPool.get("io.github.future0923.debug.tools.hotswap.core.javassist.tools.reflect.Metalevel");
        ...
        CtField f;
        if (addMeta) {
            f = new CtField(classPool.get("io.github.future0923.debug.tools.hotswap.core.javassist.tools.reflect.Metaobject"),
        ...
        f = new CtField(classPool.get("io.github.future0923.debug.tools.hotswap.core.javassist.tools.reflect.ClassMetaobject"),
