...
import io.github.future0923.debug.tools.hotswap.core.util.spring.util.PatternMatchUtils;
import io.github.future0923.debug.tools.hotswap.core.util.spring.util.StringUtils;
import io.github.future0923.debug.tools.hotswap.core.versions.ArtifactVersion;
...
import io.github.future0923.debug.tools.hotswap.core.versions.ManifestInfo;
...
import io.github.future0923.debug.tools.hotswap.core.versions.VersionRange;
...
public class ManifestMatcher implements VersionMatcher {
    private static Logger LOGGER = Logger.getLogger(ManifestMatcher.class);
    ...
    public ManifestMatcher(Manifest cfg) throws InvalidVersionSpecificationException {
        ...
        if (cfg.names() != null && cfg.names().length > 0) {
            ...
            for (io.github.future0923.debug.tools.hotswap.core.annotation.Name name : cfg.names()) {
