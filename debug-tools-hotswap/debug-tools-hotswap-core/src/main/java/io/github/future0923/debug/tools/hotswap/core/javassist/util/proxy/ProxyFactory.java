...
import io.github.future0923.debug.tools.hotswap.core.javassist.bytecode.DuplicateMemberException;
...
import io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.DefineClassHelper;
import io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.FactoryHelper;
import io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.MethodFilter;
...
import io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.ProxyObjectInputStream;
import io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.SecurityActions;
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.RuntimeSupport";
    ...
    private Class<?> getClassInTheSamePackage() {
        if (basename.startsWith("io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy."))       // maybe the super class is java.*
    ...
    private void checkClassAndSuperName() {
        ...
        if (basename.startsWith("java.") || basename.startsWith("jdk.") || onlyPublicMethods)
            basename = "io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy." + basename.replace('.', '_');
    }
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("io.github.future0923.debug.tools.hotswap.core.javassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
