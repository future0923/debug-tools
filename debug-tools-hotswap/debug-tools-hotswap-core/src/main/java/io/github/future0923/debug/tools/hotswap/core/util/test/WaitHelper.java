 ...
 */
package io.github.future0923.debug.tools.hotswap.core.util.test;
...
public class WaitHelper {
     ...
     * @return true if value was set during timeout
     */
    public static boolean waitForResult(ResultHolder resultHolder, int timeout) {
    ...
    public static abstract class Command {
         ...
         * @throws Exception any exception is considered as false result
         */
