 ...
 * @author future0923
 */
public class RunResultTypeHttpHandler extends BaseHttpHandler<RunResultTypeReq, String> {
    ...
    @Override
    protected String doHandle(RunResultTypeReq req, Headers responseHeaders) {
        ...
        if (PrintResultType.JSON.getType().equals(req.getPrintResultType())) {
            ...
            return DebugPowerJsonUtils.toJsonStr(new RunResultDTO("result", valueByOffset));
        }
        return null;
    }
}
