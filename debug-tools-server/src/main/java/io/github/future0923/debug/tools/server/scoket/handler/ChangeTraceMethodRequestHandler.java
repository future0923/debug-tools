 ...
 * @author future0923
 */
public class ChangeTraceMethodRequestHandler extends BasePacketHandler<ChangeTraceMethodRequestPacket> {
    ...
    @Override
    public void handle(OutputStream outputStream, ChangeTraceMethodRequestPacket packet) throws Exception {
