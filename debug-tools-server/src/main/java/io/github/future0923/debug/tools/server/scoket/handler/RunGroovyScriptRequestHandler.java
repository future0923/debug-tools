...
import io.github.future0923.debug.tools.common.classloader.GroovyScriptClassLoader;
...
public class RunGroovyScriptRequestHandler extends BasePacketHandler<RunGroovyScriptRequestPacket> {
    ...
    private RunGroovyScriptRequestHandler() {
        ...
        groovyScriptClassLoader.setDefaultClassLoader(AllClassLoaderHttpHandler.getDefaultClassLoader());
