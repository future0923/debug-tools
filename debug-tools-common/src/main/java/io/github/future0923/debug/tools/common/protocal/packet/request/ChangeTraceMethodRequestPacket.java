...
public class ChangeTraceMethodRequestPacket extends EntityPacket<ChangeTraceMethodRequestPacket> {
    ...
    @Override
    public void doDeserialize(ChangeTraceMethodRequestPacket packet) {
